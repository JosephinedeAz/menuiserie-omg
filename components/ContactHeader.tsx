    ...
    <>
      ...
      <section className="md:hidden bg-[#b85a3c] px-[12px] py-[10px] pb-[70px] rounded-b-[30px] flex flex-col gap-[10px]">
        <div className="px-[10px] py-[10px]">
          <h1 className="font-black text-[40px] leading-[48px] tracking-[-1.6px] text-[#2c332c]">
      ...
      <section className="hidden md:flex bg-[#b85a3c] px-[120px] pt-[40px] pb-[70px] rounded-b-[120px] flex-col gap-[24px] items-center">
        <h1 className="font-black text-[70px] leading-[80px] tracking-[-2.8px] text-[#2c332c] text-center">
          Donnez vie à votre projet.
        </h1>
